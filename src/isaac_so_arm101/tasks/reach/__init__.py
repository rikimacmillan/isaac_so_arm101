...
gym.register(
    id="Isaac-PING-TI-Reach-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": f"{__name__}.joint_pos_env_cfg:PingTiReachEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:ReachPPORunnerCfg",
    },
    disable_env_checker=True,
)
...
gym.register(
    id="Isaac-PING-TI-Reach-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": f"{__name__}.joint_pos_env_cfg:PingTiReachEnvCfg_PLAY",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:ReachPPORunnerCfg",
    },
    disable_env_checker=True,
)
...
gym.register(
    ...
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        # Point to the file we've been editing
        "env_cfg_entry_point": f"{__name__}.joint_pos_env_cfg:ReachVlaEnvCfg",
    },
    disable_env_checker=True,
)